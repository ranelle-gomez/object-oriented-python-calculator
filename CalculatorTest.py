...
class MyTestCase(unittest.TestCase):
        ...
        for a in range(-100, 100):
            for b in range(-100, 100):
                for c in range(-100, 100):
                    print('add_test',a, b, c, 'result: ', ModularCalculator.ModularCalculator.add(self, [a, b, c]))
    ...
    def test_subtract(self):
        for a in range(-100, 100):
            for b in range(-100, 100):
                for c in range(-100, 100):
                    print('subtract_test',a, b, c, 'result: ', ModularCalculator.ModularCalculator.subtract(self, [a, b, c]))
                    self.assertAlmostEqual(a-b-c, ModularCalculator.ModularCalculator.subtract(self, [a, b, c]))

    def test_multiply(self):
        for x in range(-100, 100):
            for y in range(-100, 100):
                for z in range(-100, 100):
                    print('multiply_test', x, y, z, 'result: ', ModularCalculator.ModularCalculator.multiply(self, [x, y, z]))
    ...
    def test_divide(self):
        for a in range(-100, 100):
            for b in range(-100, 100):
                for c in range(-100, 100):
                    if b == 0 or c == 0:
                        self.assertEqual('Whoops. Cannot divide by zero. 😭', ModularCalculator.ModularCalculator.divide(self, [a, b, c]))
                    else:
                        print('divide_test', a, b, c, 'result: ', ModularCalculator.ModularCalculator.divide(self, [a, b, c]))
